...
Spanning Tree and `adespatial::constr.hclust` clustering algorithm. The returned
dataframe contains a row for each pixel and an additional column containing the
clustered `site_id`.
